...
import map.config.audit.AuditEventConverter;
import map.domain.PersistentAuditEvent;
...
import static map.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
