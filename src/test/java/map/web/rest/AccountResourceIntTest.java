package map.web.rest;

import map.CleanIndexElasticSearchApp;
import map.config.Constants;
import map.domain.Authority;
import map.domain.User;
import map.repository.AuthorityRepository;
import map.repository.UserRepository;
import map.security.AuthoritiesConstants;
import map.service.MailService;
import map.service.UserService;
import map.service.dto.PasswordChangeDTO;
import map.service.dto.UserDTO;
import map.web.rest.errors.ExceptionTranslator;
import map.web.rest.vm.KeyAndPasswordVM;
import map.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = CleanIndexElasticSearchApp.class)
